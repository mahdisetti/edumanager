...
<section class="panel table-panel">
    <div class="panel-head">
        ...
        <div>
            <button onclick="exportTable('studentsTable')" class="icon-btn">
                ⇩
            </button>
        </div>
    </div>
        ...
        <tbody>
            <?php foreach ($students as $st): ?>
                <tr>
                    <td>
                        <div class="person">
                            ...
                            <div>
                                ...
                                <small>
                                    ID: #<?= htmlspecialchars($st['student_code']) ?>
                                </small>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <button class="link" onclick='editStudent(<?= json_encode($st) ?>)'>
                            Edit
                        </button>
                        ...
                        <a 
                            ...
                            href="index.php?route=students.delete&id=<?= $st['id'] ?>"
                        >
                            Delete
                        </a>
                    </td>
...
<div class="modal" id="studentModal">
    <form 
        ...
        action="index.php?route=students.store"
    >
