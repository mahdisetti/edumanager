    ...
    <div class="login-wrap">
        ...
        <form method="post" action="index.php?route=login" class="login-card">
            ...
            <div class="input-icon">
                ✉
                <input type="email" name="email" value="admin@edu-manager.com" required>
            </div>
            ...
            <div class="input-icon">
                🔒
                <input type="password" name="password" value="admin123" id="password" required>
            ...
            <button class="btn primary full">↪ Sign In to Portal</button>

            <div class="secure">🛡 256-bit Encryption • Authorized Access Only</div>
        </form>

        <!-- Footer -->
        <p class="help">Technical issues? <b>Contact IT Support</b></p>
